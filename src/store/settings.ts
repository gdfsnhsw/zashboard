...
const replaceLegacyDarkApple = (theme: string) => {
  if (theme === 'dark-apple') {
    return 'dark'
  }
  return theme
...
defaultTheme.value = replaceLegacyDarkApple(defaultTheme.value)
darkTheme.value = replaceLegacyDarkApple(darkTheme.value)
